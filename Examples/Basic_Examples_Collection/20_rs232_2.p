 ...
 * that is composed as follows: "RS232Rx (<number of characters of data frame>) <data frame received via RS232> OK".
 * This string is then issued via the console and the RS232 interface.
 *
